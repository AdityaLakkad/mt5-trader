...
RISK_AMOUNT_USD = 50.0    # always risk exactly $100 per trade
...
# ── Option A: Points ─────────────────────────────────────────────────────────
# Gold point size = 0.01, so $1 = 100 points, $2 = 200 points
TPSL = TPSLMode.POINTS
TP_POINTS = 200.0              # $2 profit target  (200 × 0.01 = $2.00)
SL_POINTS = 100.0              # $1 stop loss      (100 × 0.01 = $1.00)
